#!/usr/bin/python3
"""Module check Unittest for the max_integer
"""
...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_regular(self):
        """
        This takes from class and works it out giving the max
    ...
    def test_negative(self):
        """Test with a list of negative value and this should return the max"""
        l = [-2, -6, -1]
        result = max_integer(l)
